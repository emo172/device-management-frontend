...
<template>
  <section class="device-detail-view">
    <header class="device-detail-view__header">
      <div>
        <p class="device-detail-view__eyebrow">Device Detail</p>
    ...
    <div v-if="currentDevice" class="device-detail-view__grid">
      <el-card class="device-detail-view__card">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="分类">{{ currentDevice.categoryName }}</el-descriptions-item>
