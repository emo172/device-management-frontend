...
<template>
  <section class="reservation-detail-view">
    <header class="reservation-detail-view__hero">
      <div>
        <p class="reservation-detail-view__eyebrow">Reservation Detail</p>
        <h1>预约详情</h1>
        <p class="reservation-detail-view__description">
          聚合展示预约基本信息、审批流与签到进度，避免用户在列表、审核结果和通知之间来回切换确认状态。
        </p>
      </div>
    ...
    <template v-else>
      <div class="reservation-detail-view__grid">
...
.reservation-detail-view__eyebrow {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
...
.reservation-detail-view__hero h1,
.reservation-detail-view__card-header span {
  margin: 0;
  color: var(--app-text-primary);
}

.reservation-detail-view__description {
  max-width: 760px;
  margin: 14px 0 0;
  font-size: 15px;
  line-height: 1.8;
